...
ActiveRecord::Schema.define(version: 2022_08_13_175426) do
  ...
  create_table "promo_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.boolean "single_use_per_user", default: false
  ...
  create_table "refund_order_items", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["order_item_id"], name: "index_refund_order_items_on_order_item_id", unique: true
