...
export const PrivacyPolicyEn: FC = () => {
  return (
    <div className={s.root}>
      ...
      <p>
        Golovina Mari website administration is obliged to maintain your privacy on the Internet. We pay great attention to securing the data you provided to us. Our privacy policy is based on the General Data Protection Regulation (GDPR) of the European Union. The purposes, for which we collect your personal data are: improvement of our service, communication with visitors to this site, newsletters, user data processing for the purpose of online sales, and for other actions listed below.
      </p>
      ...
      <p>
        We collect and process your personal data only with your willing consent. With your permission, we can collect and process the following data: name and surname, e-mail address, phone number. Collection and processing of your personal information is carried out in accordance with the laws of the European Union and Russia.
      </p>
      ...
      <p>
        Records of your IP address, time of visit, browser settings, operational system and other technical information is saved in the database when you visit golovinamari.com. This data is necessary for the correct display of the website&apos;s content. It is impossible to identify the person of the visitor using this data.
      </p>
      ...
      <p>
        If you are a parent or a legal guardian of an underage child, and you know that the child has provided us with their personal information without your consent, please contact us on: If you want to change, update and delete your personal data jusct contact us — shop@golovinamari.com. It is forbidden to enter personal data of underage users without the agreement of parents or lawful guardians.
      </p>
      ...
      <p>
        Our website golovinamary.com may contain links to other websites, which are not under our control.
      </p>

      <p>
        We are not responsible for the content of these websites. We recommend you familiarize yourself with the privacy policy of every website that you visit, if such policy exists.
      </p>
      ...
      <p>
        You can contact the administration of Golovina Mari regarding any questions related to the privacy policy on: If you want to change, update and delete your personal data just contact us — shop@golovinamari.com, or by filling a contact form specified in a corresponding section of this website. If you do not agree with this privacy policy, you cannot use the services of Golovina Mari. In this case you should avoid visiting our website.
      </p>
    </div>
  )
}
