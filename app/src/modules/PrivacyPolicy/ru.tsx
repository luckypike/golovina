    ...
    <div className={s.root}>
      ...
      <ul>
        <li>
          ...
          данных и меры по обеспечению безопасности персональных данных, предпринимаемые Головиной Марией
          Николаевной(далее – Оператор).
          <ul>
            <li>
            ...
            <li>
              ...
              ко всей информации, которую Оператор может получить о посетителях веб-сайта https://golovinamari.com.
            </li>
          </ul>
        </li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://golovinamari.com ;
            </li>
            <li>
            ...
            <li>
              ...
              определяемому Пользователю веб-сайта https://golovinamari.com;
            </li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              информационных сообщений, направив Оператору письмо на адрес электронной почты shop@golovinamari.com
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              shop@golovinamari.com с пометкой «Актуализация персональных данных».
            </li>
            <li>
              ...
              электронной почты на электронный адрес Оператора shop@golovinamari.com с пометкой «Отзыв согласия на
        ...
        <li>
          ...
          <ul>
            <li>
              ...
              персональных данных, обратившись к Оператору с помощью электронной почты shop@golovinamari.com.
            </li>
            <li>
