  ...
  return (
    <>
      <div className={s.dl}>
        ...
        <div className={s.dd}><Price price={order.price_final} priceFinal={order.price_final} /></div>
      </div>

      {deliveryPrice > 0 &&
        <div className={s.dl}>
          <div className={s.dt}>{t(watchDelivery)}</div>
          <div className={s.dd}><Price price={deliveryPrice} priceFinal={deliveryPrice} /></div>
        </div>
      }

      <div className={s.dl}>
        <div className={s.dt}>{t('total')}</div>
        <div className={s.dd}><Price price={order.price_final + deliveryPrice} priceFinal={order.price_final + deliveryPrice} /></div>
      </div>
    </>
  )
})
