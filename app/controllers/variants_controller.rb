class VariantsController < ApplicationController
  ...
  def variant_params
    params.require(:variant).permit(:color_id, :code, :out_of_stock, :state, :created_at, :updated_at, :latest, :sale, :soon, :pinned, :desc, :comp, :price, :price_last, :product_id, product_attributes: [:id, :title, :category_id ], availabilities_attributes: [:id, :variant_id, :size_id, :store_id, :quantity, :_destroy], image_ids: [], images_attributes: [:id, :weight])
  end
end
