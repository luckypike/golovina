class ProductsController < ApplicationController
  ...
  def product_params
    ...
    params.require(:product).permit(:title, :category_id, :latest, :sale, :brand, :pinned, :price, :price_last, :comp, :desc, similar_product_ids: [], variants_attributes: [:created_at, :id, :color_id, :_destroy, :state, :out_of_stock, image_ids: [], sizes: size_keys, images_attributes: [:id, :weight]])
  end
end
