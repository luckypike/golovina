...
function RU () {
  return (
    <>
      ...
      <p>
        Если вы совершили покупку через интернет-магазин, то вам необходимо заполнить короткую форму возврата в вашем личном кабинете. Вернуть товар можно лично, либо курьерской службой по адресу: г. Москва, ул. Большая Никитская 21/18 стр 4, 2 этаж, помещение 206, получатель – Головина Мария Николаевна, контактный телефон +7 (985) 714-55-58.
        <br />
