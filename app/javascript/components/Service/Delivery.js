...
function RU () {
  return (
    <>
      ...
      <p>
        Стоимость доставки по Москве 350 ₽. Если заказ оформлен до 16:00, то доставка осуществляется в этот же день. Если заказ оформлен после 16:00, то доставка осуществляется на следующий день с 13:00 до 20:00.
      </p>
